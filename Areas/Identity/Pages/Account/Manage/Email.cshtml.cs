...
namespace GCUSMS.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            {
                var newmail = await _userManager.SetEmailAsync(user , Input.NewEmail);
                var newUserName = await _userManager.SetUserNameAsync(user, Input.NewEmail);
                ...
                if (newmail.Succeeded && newUserName.Succeeded)
                {
                    StatusMessage = "Your Email has been changed!";
                    _notyf.Success("You have just changed your Email Address ", 7);
